...
export default function GarmentCard({ prenda, onDelete }) {
  ...
  return (
    <div className="card group relative flex flex-col hover:shadow-md transition-shadow duration-200">
      ...
      <div className="relative aspect-square bg-gray-50 overflow-hidden">
        ...
        {/* Botón eliminar (top-right, visible al hover) */}
        <button
          onClick={() => setShowConfirm(true)}
          className="absolute top-2 right-2 p-1.5 rounded-lg bg-white/90 text-gray-400
